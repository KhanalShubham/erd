...
export const socialMediaSystem: SystemScenario = {
  ...
  canonicalEntities: [
    ...
    },
    {
      ...
      name: 'USER_FOLLOW',
      type: 'associative',
      description: 'Recursive junction table with FollowID Primary Key and Follower/Followee Foreign Keys',
      position: { x: 70, y: 390 },
      attributes: [
        { id: 'sf_0', entityId: 'ent_soc_fol', name: 'FollowID', type: 'simple', dataType: 'INTEGER', isPrimaryKey: true, isForeignKey: false, isNullable: false, isUnique: true },
        { id: 'sf_1', entityId: 'ent_soc_fol', name: 'FollowerID', type: 'simple', dataType: 'INTEGER', isPrimaryKey: false, isForeignKey: true, isNullable: false, isUnique: false, referencedEntityId: 'ent_soc_usr' },
        { id: 'sf_2', entityId: 'ent_soc_fol', name: 'FolloweeID', type: 'simple', dataType: 'INTEGER', isPrimaryKey: false, isForeignKey: true, isNullable: false, isUnique: false, referencedEntityId: 'ent_soc_usr' },
  ...
  sampleData: {
    ...
    USER_FOLLOW: [
      { FollowID: 1, FollowerID: 1, FolloweeID: 2, FollowDate: '2026-01-15' },
      { FollowID: 2, FollowerID: 2, FolloweeID: 1, FollowDate: '2026-01-16' },
    ],
  },
};
